...
class SegmentationDataset(Dataset):
    ...
    def __getitem__(self, index): 
        ...
        if self.modality == "rgb_hs":
            samples = im_rgb, im_hs
        elif self.modality== "rgb_dem":
            samples = im_rgb, im_dem
        elif self.modality== "hs_dem":
            samples = im_hs, im_dem
