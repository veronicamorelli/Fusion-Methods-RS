...
# Model
from upernet_swin_cross_att_DEMasPE import UperNet_swin
...
path_train_hs = config["path_train_hs_nopca"] 
path_val_hs = config["path_val_hs_nopca"]
path_test_hs = config["path_test_hs_nopca"]
...
path_max_dict = config["path_max_dict_tot"]
path_min_dict = config["path_min_dict_tot"]
path_max_dict01 = config["path_max_dict_tot"]
path_mean_dict01 = config["path_mean_dict_tot"]
path_std_dict01 = config["path_std_dict_tot"]

# LOAD DICTIONARIES
max_dict = load_dict(path_max_dict01)
mean_dict = load_dict(path_mean_dict01)
std_dict = load_dict(path_std_dict01)

# DATA AUGMENTATION
# Data augmentation Albumentations
normalize_rgb = A.Normalize(mean = mean_dict['rgb'], std = std_dict['rgb'], max_pixel_value = max_dict['rgb'])
normalize_hs = A.Normalize(mean = mean_dict['hs'], std = std_dict['hs'], max_pixel_value = max_dict['hs'])
normalize_dem = A.Normalize(mean = mean_dict['dem'], std = std_dict['dem'], max_pixel_value = max_dict['dem'])
